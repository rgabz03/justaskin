...
const sendMessage = async(to_user_id, message) =>{
    ...
    if(user_session != null) {
        ...
        let res = await axios.post("/users/"+user_id+"/messages/send", data ,{
                headers : {
                    'Authorization': `bearer ${access_token}`,
                    'Accept' : 'application/json',
                    'Content-Type' : 'application/json',
...
const sendMessages = async(to_user_id, message) =>{
...
export { login, logout, getCurrentUser , getCoinBalance, getUserProfile, getUserFollowerCount, handleForgotPasswordSubmit, updateUserRecieveNotification, sendMessage, likePost };
